namespace ImageResizer
{
	partial class ImageResizerForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.imagesListView.DragDrop += new System.Windows.Forms.DragEventHandler(this.picturesListView_DragDrop);
			this.imagesListView.DragEnter += new System.Windows.Forms.DragEventHandler(this.picturesListView_DragEnter);
			this.imagesListView.KeyDown += new System.Windows.Forms.KeyEventHandler(this.imagesListView_KeyDown);
			// 
			// browseButton
			// 
